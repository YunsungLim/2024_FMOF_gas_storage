...
class Builder:
    ...
    def build(self, topology, bbs, permutations=None, rod_connection_indices=None, **kwargs):
        """
        ...
        # Empty list
        if rod_connection_indices is None:
            rod_connection_indices = []
        ...
        for i in topology.node_indices:
            ...
            if permutations[i] is not None:
                ...
                located_node, rmsd, new_perm = \
                    locator.locate_with_permutation(target, node_bb, perm, rod_connection_indices)
